...
async def get_started(ctx):
    ...
    em.add_field(name="2", value="Установите канал для квестов командой $configure\_bot quest\_channel название_канала")
